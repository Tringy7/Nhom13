...
import { getOrderDetailReturnRequests, approveOrderDetailReturnRequest, rejectOrderDetailReturnRequest } from '../../util/api/adminApi';
...
const AdminReturnRequestPage = () => {
    ...
    const fetchRequests = async () => {
        setLoading(true);
        try {
            const res = await getOrderDetailReturnRequests();
            if (res.data.success) setRequests(res.data.data.data);
        } catch (err) {
    ...
    const handleProcessRequest = async () => {
        ...
        try {
            if (actionType === 'APPROVED') {
                await approveOrderDetailReturnRequest(selectedRequest.id);
            } else {
                await rejectOrderDetailReturnRequest(selectedRequest.id, { adminNotes });
            }
