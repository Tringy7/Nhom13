...
// Returns
export const getReturnRequestsApi = () => axios.get('/api/manager/return-requests');
export const processReturnRequestApi = (id, status, adminNotes) => axios.patch(`/api/manager/return-requests/${id}`, { status, adminNotes });
